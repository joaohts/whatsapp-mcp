...
A macOS app that exposes a **read-only view of your WhatsApp** to local Claude Desktop via the [Model Context Protocol](https://modelcontextprotocol.io/). Designed for one-click install: download the DMG, drag to Applications, pair with WhatsApp, click "Configure Claude" — done.
